...
from layers.EcmP_backbone_mk3 import EcmP_backbone_mk3
...
class Model(nn.Module):
    def __init__(self, configs, max_seq_len:Optional[int]=1024, d_k:Optional[int]=None, d_v:Optional[int]=None, norm:str='BatchNorm', attn_dropout:float=0., 
                 ...
                 pre_norm:bool=False, store_attn:bool=False, pretrain_head:bool=False, head_type = 'flatten', verbose:bool=False, **kwargs):
        ...
        if self.decomposition:
            ...
            self.model_trend = EcmP_backbone_mk3(c_in=c_in, context_window = context_window, target_window=target_window, patch_len=patch_len, stride=stride, 
