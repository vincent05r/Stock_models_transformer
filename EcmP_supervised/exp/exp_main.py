...
from models import Informer, Autoformer, Transformer, DLinear, Linear, NLinear, PatchTST, EcmP, EcmP_mk2
...
class Exp_Main(Exp_Basic):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.use_amp:
                    with torch.cuda.amp.autocast():
                        if 'Linear' in self.args.model or 'TST' or 'EcmP' in self.args.model:
    ...
    def test(self, setting, test=0):
        ...
        np.save(folder_path + 'metrics.npy', np.array([mae, mse, rmse, mape, mspe, rse]+ list(corr.flatten()))) #flatten the correlation array
