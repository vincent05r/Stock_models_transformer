...
#extras
result_log_path=./result_log/EcmP_mk3/ecmp_stock_v2/t1_seq_60_best_xl.txt
...
do
    ...
    if [ "$data_path_name" = "$resume_file" ] || [ $break_resume -eq 1 ]; then
        ...
        --lradj 'TST'\
        --pct_start 0.1\
        --itr 1 --batch_size 16 --learning_rate 0.00005 >logs/EcmP_mk3/ecmp_stock_v2/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log
