...
if [ ! -d "./logs/EcmP_mk3/ACL18_2022" ]; then
    mkdir ./logs/EcmP_mk3/ACL18_2022
fi
...
#extras
result_log_path=./result_log/EcmP_mk3/acl_18_ext/acl_2022_v1_mock.txt

root_path_name=./data/ACL_18_EXT/2022/
...
do
    ...
    if [ "$data_path_name" = "$resume_file" ] || [ $break_resume -eq 1 ]; then
        ...
        do
            ...
            --lradj 'TST'\
            --pct_start 0.1\
            --itr 1 --batch_size 16 --learning_rate 0.0005 >logs/EcmP_mk3/ACL18_2022/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log 
        done
