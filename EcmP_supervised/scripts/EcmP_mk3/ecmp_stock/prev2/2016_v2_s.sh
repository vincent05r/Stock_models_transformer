...
#extras
result_log_path=./result_log/EcmP_mk3/ecmp_stock/test_v2_s_lr.txt
...
do
    ...
    if [ "$data_path_name" = "$resume_file" ] || [ $break_resume -eq 1 ]; then
        ...
        do
            ...
            --lradj 'TST'\
            --pct_start 0.1\
            --itr 1 --batch_size 16 --learning_rate 0.00001 >logs/EcmP_mk3/ecmp_stock/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log 
        done
