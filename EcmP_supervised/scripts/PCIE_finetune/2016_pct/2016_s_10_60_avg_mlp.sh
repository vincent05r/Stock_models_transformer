...
do
    ...
    do
        ...
        #utils
        result_log_path="./result_log/PCIE/finetune/2016_pct_mlp.txt"
        pretrained_model_path="./pretrain_cp/PT2016V2PCIE_${seq_len}_${pred_len}_EcmP_mk3_stock_custom_pretrain_v2_ftMS_sl${seq_len}_ll0_pl${pred_len}_dm108_dp0_pl5_nh3_el3_dl1_df256_fc1_ebtimeF_Exp_dcomp0_kn9_MLP_None_rv1_close_pct_change/checkpoint.pth"
