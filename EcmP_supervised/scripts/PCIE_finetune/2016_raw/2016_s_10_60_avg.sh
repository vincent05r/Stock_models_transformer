...
#utils
result_log_path="./result_log/PCIE/finetune/2016_raw.txt"
...
do
    ...
    do
        seq_len=$pred_len
        pretrained_model_path="./pretrain_cp/PT2016V2PCIE_${seq_len}_${pred_len}_EcmP_mk3_stock_custom_pretrain_ftMS_sl${seq_len}_ll0_pl${pred_len}_dm18_dp0_pl1_nh3_el3_dl1_df128_fc1_ebtimeF_Exp_dcomp0_kn9_LOlinears_None_rv1_close/checkpoint.pth"
